...
sdo_valid = StorageDataset(sdo_valid, '/gss/r.jarolim/data/converted/sdo_2048', ext_editors=[channel_editor, RandomPatchEditor((256, 256))])

soho_valid = SOHODataset("/gss/r.jarolim/data/soho_iti2021_prep", resolution=1024, months=[11, 12], limit=100)
soho_valid = StorageDataset(soho_valid, '/gss/r.jarolim/data/converted/soho_1024', ext_editors=[channel_editor, RandomPatchEditor((128, 128))])
