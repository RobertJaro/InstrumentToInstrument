...
sdo_valid = StorageDataset(SDODataset("/gss/r.jarolim/data/sdo/valid", resolution=4096, patch_shape=(512, 512)),
                           '/gss/r.jarolim/data/converted/sdo_fullres_valid', ext_editors=[SliceEditor(0, -1)])
stereo_valid = StorageDataset(STEREODataset("/gss/r.jarolim/data/stereo_prep/valid", patch_shape=(128, 128)),
...
full_disc_aba_callback = PlotABA(STEREODataset("/gss/r.jarolim/data/stereo_prep/train").sample(1),
                                 trainer, prediction_dir, log_iteration=log_iteration,
                                 plot_settings_A=plot_settings_A, plot_settings_B=plot_settings_B,
